...
import org.order.OrderResource;
...
public class OrderResourceTest {
    ...
    public void create_order_with_sufficient_inventory() {
        ...
        InventoryID inventoryID = new InventoryID(uuid);
        ...
        Mockito.when(
                ...
                .thenReturn(Uni.createFrom().item(Set.of(new InventoryResponseDTO(inventoryID, 5, 0))));
